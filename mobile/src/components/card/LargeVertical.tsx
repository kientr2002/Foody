...
const LargeVertical = (): JSX.Element => {
    return (
        <Pressable style={[styles.background, styles.backgroundLargeVertical]}>
            <Image
                style={styles.imgLargeVertical}
                source={{
