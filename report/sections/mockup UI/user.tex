\subsection{User view}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Home.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/My Plan.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Search.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Favorite.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Profile - user.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Dish detail - about.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Dish detail - review.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Create plan.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Calculate TDEE.pdf}}
