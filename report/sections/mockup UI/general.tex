\subsection{General View}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Login.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Sign up.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Forgot password-1.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Forgot password-2.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Forgot password-3.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Change password-1.pdf}}
    ...
    \begin{minipage}{0.5\textwidth}
        \vspace{1cm}
        \fbox{\includegraphics[width=\textwidth]{images/ui/Change password-2.pdf}}
