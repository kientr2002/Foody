...
export default function Button({ content, type, arrow, comment, onPress }:ButtonAttribute) {
    ...
    return (
        ...
        >
            <LinearGradient
                colors={pressed ? ['rgba(0, 0, 0, 0.4)', selectedColor[0]] : selectedColor}
                style={comment ? [styles.button, styles.comment] : styles.button}
                start={{ x:0, y:0 }}
                end={{ x:1, y:1 }}
